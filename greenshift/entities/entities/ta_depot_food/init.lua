...
function ENT:Break()
	for i = 1, 7 do
		...
		debris:SetAngless(Angle(math.random(0, 360), math.random(0, 360), math.random(0, 360)))
		debris:Spawn()
		debris:Activate()
	...
	for i = 1, 7 do
		...
		food:SetAngless(Angle(math.random(0, 360), math.random(0, 360), math.random(0, 360)))
		food:Spawn()
		food:Activate()
